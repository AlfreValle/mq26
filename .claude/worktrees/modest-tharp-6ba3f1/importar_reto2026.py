...
Uso:
    python importar_reto2026.py           # importa si no existe
    python importar_reto2026.py --forzar  # elimina filas previas y re-importa
    python importar_reto2026.py --preview # muestra la tabla sin tocar el CSV
"""
...
CSV_PATH = Path(__file__).parent / "0_Data_Maestra" / "Maestra_Transaccional.csv"
TIPO     = "CEDEAR"
